...
<head>
    ...
    <title>Baka Eszter · Lashes</title>
    ...
    <style>
          ...
          .animation--fade-bg-1 {
            ...
            @keyframes fade-bg-1 {
                from {
                    opacity: 0;
                    background-image: url('img/lashes/Polish_20220319_222306007.jpg');
                }
            ...
            @keyframes fade-bg-2 {
                from {
                    opacity: 0;
                    background-image: url('img/lashes/Polish_20220527_225940583.jpg');
                }
...
<body onload="attunes()">
    ...
    <section id="oktatas">
        ...
        <div class="row justify-content-center">
            ...
            <div class="szoveg">
            <p align="justify">A műszempilla építés során a természetesebb hatást helyezem előtérbe. Az archoz, szemformához illő szettek építésével egy olyan végeredmény megvalósítasára törekszem, ami a vendégemet a tükörbe pillantasáskor maximális elégedettséggel tölti el.</p>
            </div>
          ...
          <div id="hennabtn" class="row justify-content-center">
            <a id="tovabbbtn" class="btn btn-primary" href="./lashes.php">További képek <i class="bi bi-arrow-right-circle"></i></a>
          </div>
