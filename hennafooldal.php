    ...
    <style>
          ...
          .animation--fade-bg-1 {
            ...
            @keyframes fade-bg-1 {
                from {
                    opacity: 0;
                    background-image: url('img/henna/20190315_095740.jpg');
                }
            ...
            @keyframes fade-bg-2 {
                from {
                    opacity: 0;
                    background-image: url('img/henna/inCollage_20190303_175150349.jpg');
                }
...
<body onload="attunes()">
    ...
    <section id="oktatas">
        ...
        <div class="row justify-content-center">
            ...
            <div class="szoveg">
            <p align="justify">A hennafestés alapanyagául szolgáló növény, a henna. Trópusi országok területén termesztik a hennát mint festőnövényt, évezredek óta ismerik és használják testfestésre. Elsősorban bőrt festenek vele, de használják haj és köröm festésére is és azon túl, különböző egészséges hatásai vannak, – köztük a láz csökkentésének képessége, fejfájás elmulasztása, és az alvászavarok csökkentése.
A hennafestés hennapéppel készül, amit a henna növény levelének az örleményéből áll.  Kerül még bele cukor, citromlé és eukaliptusz vagy levendula olaj. A minta először narancs színű lesz, majd 1-2 nap alatt bebarnul , beérik (a festett bőrterület függvényében különböző erősségű barna színűre festi meg a bőrt), a fennmaradási ideje bőrtípustól függően 1-2 hét. A henna a bőr felső hámrétegét festi meg. A minta a fennmaradási idő eltelte után fokozatosan elhalványul, majd teljesen eltűnik, ahogy a bőr hámrétege cserélődik.
A henna festést nem csak a test díszítésére használták, hanem a hiedelem szerint viselőjének gazdagságot, szerencsét hozott és a gonosz elűzésére szolgált. A henna bőséggel, jósággal, szerelemmel, erővel áldja meg viselőjét.
A henna festés terápiát is nyújt, a festés egy rituálé,a mögöttes tartalma is nagyon fontos benne. Nem egy múló, gyorsan lecsengő divat, a henna örök.
A henna viselőjének és alkotójának jellemét, stílusát kifejező, testet és lelket szépítő élmény.</p>
            </div>
          ...
          <div id="hennabtn" class="row justify-content-center">
            <a id="tovabbbtn" class="btn btn-primary" href="./henna.php">További képek <i class="bi bi-arrow-right-circle"></i></a>
          </div>
