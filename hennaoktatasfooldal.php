...
<head>
    ...
    <title>Baka Eszter · Henna oktatás</title>
    ...
    <style>
          ...
          .animation--fade-bg-1 {
            ...
            @keyframes fade-bg-1 {
                from {
                    opacity: 0;
                    background-image: url('img/henna_oktatas/oktatas1.jpg');
                }
            ...
            @keyframes fade-bg-2 {
                from {
                    opacity: 0;
                    background-image: url('img/henna_oktatas/oktatas2.jpg');
                }
...
<body onload="attunes()">
    ...
    <section id="oktatas">
        ...
        <div class="row justify-content-center">
            ...
            <div class="szoveg">
            <p align="justify">Ha szeretnéd megtanulni a henna festést és a henna pép elkészítését vagy egy jó hangulatú csajos programban gondolkozol - akár egy születésnap vagy lánybúcsú alkalmából -, egyéni vagy csoportos oktatásra is van lehetőség nálam. 
                Rendezvényekre, zsúrokra is keress bizalommal!</p>
            </div>
