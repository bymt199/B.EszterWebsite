...
<head>
    ...
    <title>Baka Eszter · Galéria</title>
...
<body>
    ...
    <section id="gallery">
        ...
        <div class="row justify-content-center">
            <p><a href="index.php">Főoldal</a>/<a href="gallery.php">Galéria</a></p>
            <h1>Galéria</h1>
            
            <div id="mappak">
            <div id="gyujto1">
                <a href="henna.php"><i class="bi bi-folder2"></i></a>
                <h5>Henna</h5>
            </div>
    
        
            <div id="gyujto2">
                <a href="hennaoktatas.php"><i class="bi bi-folder2"></i></a>
                <h5>Henna oktatás</h5>
            </div>
        
        
            <div id="gyujto3">
                <a href="jagua.php"><i class="bi bi-folder2"></i></a>
                <h5>Jagua</h5>
            </div>
       
        
            <div id="gyujto4">
                <a href="lashes.php"><i class="bi bi-folder2"></i></a>
                <h5>Lashes</h5>
            </div>
        
        
            <div id="gyujto5">
                <a href="makeup.php"><i class="bi bi-folder2"></i></a>
                <h5>Makeup</h5>
            </div>
            </div>
