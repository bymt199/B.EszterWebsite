...
<head>
    ...
    <title>Baka Eszter · Szolgáltatások</title>
...
<body>
    ...
    <section id="gallery">
        <div class="container d-grid h-100vh">
        <div class="row justify-content-center">
            <h1>Szolgáltatások</h1>
            
            <div id="mappak">
            <div id="gyujto1">
                <a href="./hennafooldal.php"><img src="./img/hennaicon.png" alt="hennát ábrázoló kéz ikon"></a>
                <h5>Henna</h5>
            </div>
    
        
            <div id="gyujto2">
                <a href="./hennaoktatasfooldal.php"><img src="./img/hennaicon.png" alt="hennát ábrázoló kéz ikon"></a>
                <h5>Henna oktatás</h5>
            </div>
        
        
            <div id="gyujto3">
                <a href="./jaguafooldal.php"><img src="./img/hennaicon.png" alt="hennát ábrázoló kéz ikon"></i></a>
                <h5>Jagua</h5>
            </div>
       
        
            <div id="gyujto4">
                <a href="./makeupfooldal.php"><img src="./img/makeup.png" alt="sminket ábrázoló ikon"></i></a>
                <h5>Makeup</h5>
            </div>


            <div id="gyujto5">
                <a href="./lashesfooldal.php"><img src="./img/lashes.png" alt="szempillát ábrázoló ikon"></i></i></a>
                <h5>Lashes</h5>
            </div>
